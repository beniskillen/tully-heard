          ...
          >
            ...
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden group">
              ...
              <button className="absolute inset-0 flex items-center justify-center group/play">
                <div className="w-20 h-20 rounded-full bg-primary/90 backdrop-blur flex items-center justify-center group-hover/play:scale-110 transition-transform shadow-lg">
                  <Play className="text-primary-foreground fill-current ml-1" size={32} />
                </div>
              </button>
              <div className="absolute bottom-6 left-6 right-6">
                <div className="inline-block px-4 py-2 rounded-full bg-primary/20 backdrop-blur-sm border border-primary/30">
                  <span className="text-primary font-semibold">{currentCase.result}</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:pl-8">
              ...
              <h3 className="text-3xl lg:text-4xl font-display font-semibold text-foreground mb-2">
                {currentCase.title}
              </h3>
              <p className="text-primary text-lg mb-4">{currentCase.subtitle}</p>
